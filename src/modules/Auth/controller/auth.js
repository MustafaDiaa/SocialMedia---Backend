        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account with Paste, you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end copy -->
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">If that doesn't work, regenerate new email confirmation mail from this link:</p>
              <p style="margin: 0;"><a href="${refreshLink}" target="_blank">Click here to send another confirmation email </a></p>
            </td>
          </tr>
          <!-- end copy -->
...
export const confirmEmail = asyncHandler(async (req, res, next) => {
  ...
  return user.modifiedCount
    ? res.status(200).redirect("http://localhost:5000/post")
...
<body style="background-color: #e9ecef;">
  ...
  return res
    .status(200)
    .send("<p>A new email has been sent to your account, please check.</p>");
});
...
export const login = asyncHandler(async (req, res, next) => {
  ...
  if (!user.confirmEmail) return next(new Error("Please confirm your Email"));
...
export const sendForgetCode = asyncHandler(async (req, res, next) => {
  ...
  if (!user) return next(new Error("Not registered account", { cause: 400 }));
    ...
    <tr>
      <td align="center" bgcolor="#e9ecef">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Check the code below to reset password of your email address. If you didn't requested reset password, you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end copy -->
                ...
                <tr>
                  <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <p style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">${forgetCode}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
...
export const forgetPassword = asyncHandler(async (req, res, next) => {
  ...
  if (match)
    return next(
      new Error("Please enter a different password other than the old one", {
        cause: 400,
      })
    );
